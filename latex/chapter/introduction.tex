...
The structure of the present paper deviates from the statistical literature, which usually first presents a method that is then applied to real data and compared to existing benchmarks.
